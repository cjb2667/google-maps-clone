...
/**
 * 右上角功能工具栏:
 * 路线、测距、卷帘、时光机、3D、天气、飞行模式、实时航班、ISS、日夜主题、随机传送
 */
  ...
  return (
    <div className="toolbar">
      ...
      >
        {/* 雷达扫描图标(区别于飞行模式的飞机) */}
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2a10 10 0 1 0 10 10h-2a8 8 0 1 1-8-8V2zm0 4a6 6 0 1 0 6 6h-2a4 4 0 1 1-4-4V6zm0 4a2 2 0 1 0 2 2l6-6-1.41-1.41L12.6 10.6A2 2 0 0 0 12 10z" />
        </svg>
      </button>
      <button
